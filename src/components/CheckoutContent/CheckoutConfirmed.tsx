...
const CheckoutConfirmed = () => {
    ...
    return <div className="confirmed">
        ...
        <p className="order-msg"> Thank you Joe for buying Candleaf. The nature is grateful to you. Now that your order is confirmed it will be ready to ship in 2 days. Please check your inbox in the future for your order updates.</p>
        <CustomButton className="back-to-shopping-btn" name="Back to shopping" onClick={() => navigate('/')} />
